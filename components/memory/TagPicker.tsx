...
const COLORS = [
  ...
  { name: 'purple', label: 'Violet', bg: 'bg-purple-100 dark:bg-purple-800/30', text: 'text-purple-700 dark:text-purple-300', border: 'border-purple-200 dark:border-purple-700' },
  ...
  { name: 'pink', label: 'Rose', bg: 'bg-pink-100 dark:bg-pink-800/30', text: 'text-pink-700 dark:text-pink-300', border: 'border-pink-200 dark:border-pink-700' },
